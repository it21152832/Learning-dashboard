...
// const CourseContent = ({ subscribed, subscribe, match }) => {
//     const [courseDetails, setCourseDetails] = useState(null);
//     const [loading, setLoading] = useState(true);
//     const [error, setError] = useState(null);

//     const courseId = match.params.course_id; // Assuming you have courseId in the route params
...
//                                 <div>{/* Add additional course description data if available */}</div>
//                             </h3>
//                         </div>
//                         <div><h3 className='font-filson text-white text-sm mt-2'>Created By <span className='text-[#9300ff] cursor-pointer underline'>Paul Hodgson</span></h3></div>
//                         {/* <div><button className='flex font-filson text-[14px] w-auto h-auto p-2 bg-blue text-white rounded-xl mt-2'>Subscribe</button></div> */}
...
//                         {/* left  */}
//                         < div >
//                             <div> <h1 className='font-filson text-semibold lg:mt-0 min-[320px]:mt-10 text-white text-2xl'>{course.course_name}</h1></div>
//                             <div><h3 className='font-filson text-white text-sm mt-2'><div>A practical programming course for office workers, academics, and administrators</div> <div>who want to improve their productivity.</div></h3></div>
//                             <div><h3 className='font-filson text-white text-sm mt-2'>Created By <span className='text-[#9300ff] cursor-pointer underline'>Paul Hodgson</span></h3></div>
//                             {/* <div><button className='flex font-filson text-[14px] w-auto h-auto p-2 bg-blue text-white rounded-xl mt-2'>Subscribe</button></div> */}
//                             {!subscribed ? (
...
// const CourseContent = ({ subscribed, subscribe, courseId }) => {
//     const [courseDetails, setCourseDetails] = useState(null);
...
//                     <div className="absolute bg-purple rounded-md lg:border-2 lg:border-purple top-10 lg:w-[265px] lg:h-[550px] right-8">
//                         <div>
//                             <video className="lg:flex min-[320px]:hidden rounded-t-lg ml-[-1px] mt-[-1px] lg:w-[270px] lg:h-[150px] min-[320px]:w-[150px] min-[320px]:h-[150px] mt-2 ml-1" src={video2} controls />
//                         </div>
...
//                                 <h2 className="text-filson text-[20px] text-black font-bold">This course includes:</h2>
//                             </div>
//                             {/* ... (your existing code for course details) */}
//                             {!subscribed ? (
//                                 <div className="flex items-center justify-center">
//                                     <button onClick={handleSubscribe} className="flex font-filson text-[14px] h-[40px] items-center justify-center w-1/2 bg-[#9300ff] text-white shadow-lg shadow-blue/60 hover:bg-blue/90 rounded-2xl mt-8">
//                                         Subscribe
//                                     </button>
//                                 </div>
//                             ) : (
//                                 <div className="flex items-center justify-center">
//                                     <button className="flex font-filson text-[14px] h-[40px] items-center justify-center w-1/2 bg-gray-400 text-white shadow-lg rounded-2xl mt-8">
//                                         Subscribed
//                                     </button>
//                                 </div>
//                             )}
